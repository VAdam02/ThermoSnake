...
#define EMPTY -255
#define COOLDOWN 500
#define LENGTH 20 //LENGTH * COOLDOWN / 1000 seconds

#define PIN0 A2
#define PIN1 A3

#define RESISTANCEATREF0 120.0
#define CELSIUSATREF0 11.4
#define RESISTANCEATREF1 125.0
#define CELSIUSATREF1 23.4
